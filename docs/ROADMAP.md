...
| 任务 | 状态 | 分支 | 说明 |
|---|---|---|---|
| 管线数据驱动配置 + fetch 脚本 | todo | - | sources/chapters.config.json，抓取卷31–45 |
| 卷32 先主传 | todo | - | 每批：对齐翻译+裴注白话+实体+人物 bio |
| 卷33 后主传 | todo | - | |
| 卷36 关张马黄赵传 | todo | - | |
| 卷34/37–45 其余各卷 | todo | - | 重要传记优先，预计 8–12 批 |
| 卷35 诸葛亮传裴注白话补全 | todo | - | 正文已完成，60 条裴注补 translation |
